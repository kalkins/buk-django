...
urlpatterns = [
    ...
    url(r'^slagverkgrupper/$', member_views.PercussionGroupList.as_view(), name='percussion_group_list'),
    url(r'^slagverkgrupper/ny$', member_views.AddPercussionGroup.as_view(), name='percussion_group_add'),
    url(r'^slagverkgrupper/(?P<pk>[0-9]+)/endre$', member_views.ChangePercussionGroup.as_view(), name='percussion_group_change'),
]
